...
def runscript(datapoints):
    ...
    fullname = pd.read_csv("C:/Users/Olivier.Kraaijeveld/Documents/Projecten/Project Short/Sourcefiles/fullname.csv", sep=";", names=['Ticker', 'FullName'], skiprows=[0])
    ...
    sender_email = "olivier.kraaijeveld@kempen.com"
    receiver_email = ['pepijn.kluin@kempen.com', 'martin.ligthart@kempen.com', 'huib.meulenbelt@kempen.com', 'olivier.kraaijeveld@kempen.com']
...
if not datapoints.UpdateTimeStamp.iloc[0].date() == date.today():
    ...
    sender_email = "olivier.kraaijeveld@kempen.com"
    receiver_email = ['pepijn.kluin@kempen.com', 'olivier.kraaijeveld@kempen.com']
    ...
    html = """\
    <html>
    <p><h4>Please update the short interest information!</h4><p>Hi Pepijn,</p><p>The automatic short interest tool has noticed that today's data has not yet been updated</p><p>Please update the short interest data file <strong>within 20 minutes </strong>in the folder&nbsp;<a href='K:\Trading\Short%20Interest Report' target='_blank'>here</a>&nbsp;</p><p>Thank you</p><p>Kempen Securities</p><p><span style='font-size: 6.0pt; text-transform: uppercase; letter-spacing: .5pt;'>Kempen&nbsp; N.V.&nbsp; Beethovenstraat 300&nbsp;&nbsp; 1077 WZ Amsterdam <br />Chamber of Commerce Amsterdam: 34186722</span><span style='font-size: 7.0pt; text-transform: uppercase; letter-spacing: .5pt;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p><p><span style='font-size: 7.0pt; text-transform: uppercase; letter-spacing: .5pt;'>THIS IS AN AUTOMATED MESSAGE, PLEASE DO NOT REPLY TO THIS EMAIL ADDRESS!</span></p><p></p>
    </html>
    """
    message.attach(MIMEText(html, "html"))
    ...
    # If data still was not updated after 30 minutes, send email that data data was not updated and ask to update tomorrow
        ...
        html = """\
        <html>
        <p><h4>You have not updated today's short interest data, please update the data tomorrow!</h4><p>Hi Pepijn,</p><p>The automatic short interest tool has noticed that today's data still has not been updated.<p>The tool will run again tomorrow (except on weekend days) at 15.00, please make sure that you update the data on time!</p><p>If you have updated the data but still received this email, please contact Robbert van der Have (Quant Analyst) <a href='mailto:Robbert.vanderHave@kempen.com'>here</a>.</p><p>Thank you</p><p>Kempen Securities</p><p><span style='font-size: 6.0pt; text-transform: uppercase; letter-spacing: .5pt;'>Kempen&nbsp; N.V.&nbsp; Beethovenstraat 300&nbsp;&nbsp; 1077 WZ Amsterdam <br />Chamber of Commerce Amsterdam: 34186722</span><span style='font-size: 7.0pt; text-transform: uppercase; letter-spacing: .5pt;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p><p><span style='font-size: 7.0pt; text-transform: uppercase; letter-spacing: .5pt;'>THIS IS AN AUTOMATED MESSAGE, PLEASE DO NOT REPLY TO THIS EMAIL ADDRESS!</span></p>
        </html>
        """
        message.attach(MIMEText(html, "html"))
